import { discordIntegrationUI } from './bim-components/DiscordIntegration/src/user-interface';
...
import { AppManager, DiscordIntegration, discordIntegrationUI } from "./bim-components";
...
discordIntegration.setup({
  webhookURL: "https://discord.com/api/webhooks/1255108537965609001/xs0XNVwK8NEbJKzTzIKTkOSrJhK-YSh4i5BM6qucIjQkMjpyW4htgwCqqDHv0_LW5DCH"
})

// discordIntegration.sendMessage("Helloooooo")
